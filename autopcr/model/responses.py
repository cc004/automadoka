...
class NotificationApiUnsetTagResponse(ResponseBase):
    result: bool = None
class MstApiGetItemMstListResponse(ResponseBase):
    mstList: List[ItemItemMstRecord] = None
class MstApiGetCardMstListResponse(ResponseBase):
    mstList: List[CardCardMstRecord] = None
class MstApiGetCardLimitBreakMstListResponse(ResponseBase):
    mstList: List[CardCardLimitBreakMstRecord] = None
class MstApiGetSkillMstListResponse(ResponseBase):
    mstList: List[SkillSkillMstRecord] = None
class MstApiGetSkillLevelUpConditionMstListResponse(ResponseBase):
    mstList: List[SkillSkillLevelUpConditionMstRecord] = None
class MstApiGetCharacterAwakeMstListResponse(ResponseBase):
    mstList: List[CharacterCharacterAwakeMstRecord] = None
class MstApiGetCharacterMstListResponse(ResponseBase):
    mstList: List[CharacterCharacterMstRecord] = None
class MstApiGetCharacterProfileMstListResponse(ResponseBase):
    mstList: List[CharacterCharacterProfileMstRecord] = None
class MstApiGetCharacterHeartMstListResponse(ResponseBase):
    mstList: List[CharacterCharacterHeartMstRecord] = None
class MstApiGetCharacterHeartParamUpGroupMstListResponse(ResponseBase):
    mstList: List[CharacterCharacterHeartParamUpGroupMstRecord] = None
class MstApiGetCharacterHeartObjectRewardMstListResponse(ResponseBase):
    mstList: List[CharacterCharacterHeartObjectRewardMstRecord] = None
class MstApiGetCharacterHeartLevelUpMstListResponse(ResponseBase):
    mstList: List[CharacterCharacterHeartLevelUpMstRecord] = None
class MstApiGetCharacterTeamMstListResponse(ResponseBase):
    mstList: List[CharacterCharacterTeamMstRecord] = None
class MstApiGetStyleMstListResponse(ResponseBase):
    mstList: List[StyleStyleMstRecord] = None
class MstApiGetTowerMstListResponse(ResponseBase):
    mstList: List[TowerTowerMstRecord] = None
class MstApiGetQuestCategoryMstListResponse(ResponseBase):
    mstList: List[QuestOutGameQuestCategoryMstRecord] = None
class MstApiGetQuestMapMstListResponse(ResponseBase):
    mstList: List[QuestOutGameQuestMapMstRecord] = None
class MstApiGetQuestGroupMstListResponse(ResponseBase):
    mstList: List[QuestOutGameQuestGroupMstRecord] = None
class MstApiGetQuestStageMstListResponse(ResponseBase):
    mstList: List[QuestOutGameQuestStageMstRecord] = None
class MstApiGetQuestConditionMstListResponse(ResponseBase):
    mstList: List[QuestOutGameQuestConditionMstRecord] = None
class MstApiGetMissionTitleMstListResponse(ResponseBase):
    mstList: List[MissionMissionTitleMstRecord] = None
class MstApiGetMissionTransitionMstListResponse(ResponseBase):
    mstList: List[MissionMissionTransitionMstRecord] = None
class MstApiGetSubscriptionMissionRewardMstListResponse(ResponseBase):
    mstList: List[MissionSubscriptionMissionRewardMstRecord] = None
class MstApiGetMissionMstListResponse(ResponseBase):
    mstList: List[MissionMissionMstRecord] = None
class MstApiGetEnemyMstListResponse(ResponseBase):
    mstList: List[QuestOutGameEnemyMstRecord] = None
class MstApiGetEnemyProfileMstListResponse(ResponseBase):
    mstList: List[QuestOutGameEnemyProfileMstRecord] = None
class MstApiGetQuestEnemyAppearanceMstListResponse(ResponseBase):
    mstList: List[QuestOutGameQuestEnemyAppearanceMstRecord] = None
class MstApiGetQuestEnemySkillSetMstListResponse(ResponseBase):
    mstList: List[QuestOutGameQuestEnemySkillSetMstRecord] = None
class MstApiGetBreakMstListResponse(ResponseBase):
    mstList: List[QuestOutGameBreakMstRecord] = None
class MstApiGetAbilityEffectTypeMstListResponse(ResponseBase):
    mstList: List[SkillAbilityEffectTypeMstRecord] = None
class MstApiGetSkillDetailMstListResponse(ResponseBase):
    mstList: List[SkillSkillDetailMstRecord] = None
class MstApiGetQuestRewardMstListResponse(ResponseBase):
    mstList: List[QuestOutGameQuestRewardMstRecord] = None
class MstApiGetFieldSeriesMstListResponse(ResponseBase):
    mstList: List[ExplorationFieldSeriesMstRecord] = None
class MstApiGetFieldStageMstListResponse(ResponseBase):
    mstList: List[ExplorationFieldStageMstRecord] = None
class MstApiGetAdvMstListResponse(ResponseBase):
    mstList: List[ExplorationAdvMstRecord] = None
class MstApiGetAdvTitleMstListResponse(ResponseBase):
    mstList: List[ExplorationAdvTitleMstRecord] = None
class MstApiGetObjectReceiveTypeMstListResponse(ResponseBase):
    mstList: List[ObjectObjectReceiveTypeMstRecord] = None
class MstApiGetPayTypeMstListResponse(ResponseBase):
    mstList: List[ObjectPayTypeMstRecord] = None
class MstApiGetTalismanMstListResponse(ResponseBase):
    mstList: List[TalismanTalismanMstRecord] = None
class MstApiGetTalismanParamMstListResponse(ResponseBase):
    mstList: List[TalismanTalismanParamMstRecord] = None
class MstApiGetTalismanParamEffectMstListResponse(ResponseBase):
    mstList: List[TalismanTalismanParamEffectMstRecord] = None
class MstApiGetTalismanSeriesMstListResponse(ResponseBase):
    mstList: List[TalismanTalismanSeriesMstRecord] = None
class MstApiGetPassiveSkillMstListResponse(ResponseBase):
    mstList: List[SkillPassiveSkillMstRecord] = None
class MstApiGetPassiveSkillDetailMstListResponse(ResponseBase):
    mstList: List[SkillPassiveSkillDetailMstRecord] = None
class MstApiGetLeaderSkillMstListResponse(ResponseBase):
    mstList: List[SkillLeaderSkillMstRecord] = None
class MstApiGetLeaderSkillDetailMstListResponse(ResponseBase):
    mstList: List[SkillLeaderSkillDetailMstRecord] = None
class MstApiGetPvpRankingRewardMstListResponse(ResponseBase):
    mstList: List[PvpPvpRankingRewardMstRecord] = None
class MstApiGetPvpPointRewardMstListResponse(ResponseBase):
    mstList: List[PvpPvpPointRewardMstRecord] = None
class MstApiGetUserTitleMstListResponse(ResponseBase):
    mstList: List[UserTitleUserTitleMstRecord] = None
class MstApiGetGuildTitleMstListResponse(ResponseBase):
    mstList: List[GuildGuildTitleMstRecord] = None
class MstApiGetUserLevelUpMstListResponse(ResponseBase):
    mstList: List[UserUserLevelUpMstRecord] = None
class MstApiGetShopSeriesMstListResponse(ResponseBase):
    mstList: List[ShopShopSeriesMstRecord] = None
class MstApiGetShopMstListResponse(ResponseBase):
    mstList: List[ShopShopMstRecord] = None
class MstApiGetShopDetailMstListResponse(ResponseBase):
    mstList: List[ShopShopDetailMstRecord] = None
class MstApiGetBannerMstListResponse(ResponseBase):
    mstList: List[HomeBannerMstRecord] = None
class MstApiGetBannerLabelMstListResponse(ResponseBase):
    mstList: List[HomeBannerLabelMstRecord] = None
class MstApiGetHomeBannerMstListResponse(ResponseBase):
    mstList: List[HomeHomeBannerMstRecord] = None
class MstApiGetHomeAppealMstListResponse(ResponseBase):
    mstList: List[HomeHomeAppealMstRecord] = None
class MstApiGetTipsMstListResponse(ResponseBase):
    mstList: List[TipsTipsMstRecord] = None
class MstApiGetGveMstListResponse(ResponseBase):
    mstList: List[GveGveMstRecord] = None
class MstApiGetGveStageMstListResponse(ResponseBase):
    mstList: List[GveGveStageMstRecord] = None
class MstApiGetGveStageRewardMstListResponse(ResponseBase):
    mstList: List[GveGveStageRewardMstRecord] = None
class MstApiGetMapGveMstListResponse(ResponseBase):
    mstList: List[MapGveMapGveMstRecord] = None
class MstApiGetMapGveAreaMstListResponse(ResponseBase):
    mstList: List[MapGveMapGveAreaMstRecord] = None
class MstApiGetMapGvePointMstListResponse(ResponseBase):
    mstList: List[MapGveMapGvePointMstRecord] = None
class MstApiGetLoginBonusMstListResponse(ResponseBase):
    mstList: List[LoginBonusLoginBonusMstRecord] = None
class MstApiGetLoginBonusRewardMstListResponse(ResponseBase):
    mstList: List[LoginBonusLoginBonusRewardMstRecord] = None
class MstApiGetStyleFigureMstListResponse(ResponseBase):
    mstList: List[StyleStyleFigureMstRecord] = None
class MstApiGetStyleFigureStoryMstListResponse(ResponseBase):
    mstList: List[StyleStyleFigureStoryMstRecord] = None
class MstApiGetStyleParamUpTreeMstListResponse(ResponseBase):
    mstList: List[StyleStyleParamUpTreeMstRecord] = None
class MstApiGetStyleParamUpMstListResponse(ResponseBase):
    mstList: List[StyleStyleParamUpMstRecord] = None
class MstApiGetStyleParamUpCostMstListResponse(ResponseBase):
    mstList: List[StyleStyleParamUpCostMstRecord] = None
class MstApiGetStyleParamUpEffectMstListResponse(ResponseBase):
    mstList: List[StyleStyleParamUpEffectMstRecord] = None
class MstApiGetStyleLimitBreakMstListResponse(ResponseBase):
    mstList: List[StyleStyleLimitBreakMstRecord] = None
class MstApiGetStyleLimitBreakEffectMstListResponse(ResponseBase):
    mstList: List[StyleStyleLimitBreakEffectMstRecord] = None
class MstApiGetStyleLevelUpMstListResponse(ResponseBase):
    mstList: List[StyleStyleLevelUpMstRecord] = None
class MstApiGetStyleVoiceMstListResponse(ResponseBase):
    mstList: List[StyleStyleVoiceMstRecord] = None
class MstApiGetGvgPointRewardMstListResponse(ResponseBase):
    mstList: List[GvgGvgPointRewardMstRecord] = None
class MstApiGetGvgRankingRewardMstListResponse(ResponseBase):
    mstList: List[GvgGvgRankingRewardMstRecord] = None
class MstApiGetChatStampMstListResponse(ResponseBase):
    mstList: List[ChatChatStampMstRecord] = None
class MstApiGetBattleConditionMstListResponse(ResponseBase):
    mstList: List[QuestBattleBattleConditionMstRecord] = None
class MstApiGetBattleConditionSetMstListResponse(ResponseBase):
    mstList: List[QuestBattleBattleConditionSetMstRecord] = None
class MstApiGetEnemyConditionSetsAndActionMstListResponse(ResponseBase):
    mstList: List[QuestBattleEnemyConditionSetsAndActionMstRecord] = None
class MstApiGetDioramaBackgroundMstListResponse(ResponseBase):
    mstList: List[CollectionDioramaBackgroundMstRecord] = None
class MstApiGetLive2DParamMstListResponse(ResponseBase):
    mstList: List[CollectionLive2DParamMstRecord] = None
class MstApiGetGvgMstListResponse(ResponseBase):
    mstList: List[GvgGvgMstRecord] = None
class MstApiGetSoundMstListResponse(ResponseBase):
    mstList: List[SoundSoundMstRecord] = None
class MstApiGetCollectionIllustMstListResponse(ResponseBase):
    mstList: List[CollectionCollectionIllustMstRecord] = None
class MstApiGetCollectionIllustPieceMstListResponse(ResponseBase):
    mstList: List[CollectionCollectionIllustPieceMstRecord] = None
class MstApiGetCollectionParamUpMstListResponse(ResponseBase):
    mstList: List[CollectionCollectionParamUpMstRecord] = None
class MstApiGetCollectionParamUpLevelMstListResponse(ResponseBase):
    mstList: List[CollectionCollectionParamUpLevelMstRecord] = None
class MstApiGetCollectionParamUpEffectMstListResponse(ResponseBase):
    mstList: List[CollectionCollectionParamUpEffectMstRecord] = None
class MstApiGetCollectionConditionGroupMstListResponse(ResponseBase):
    mstList: List[CollectionCollectionConditionGroupMstRecord] = None
class MstApiGetCollectionConditionMstListResponse(ResponseBase):
    mstList: List[CollectionCollectionConditionMstRecord] = None
class MstApiGetCollectionRewardMstListResponse(ResponseBase):
    mstList: List[CollectionCollectionRewardMstRecord] = None
class MstApiGetStoryEventMstListResponse(ResponseBase):
    mstList: List[StoryEventStoryEventMstRecord] = None
class MstApiGetStoryEventQuestStageMstListResponse(ResponseBase):
    mstList: List[StoryEventStoryEventQuestStageMstRecord] = None
class MstApiGetMiniTutorialMstListResponse(ResponseBase):
    mstList: List[TutorialMiniTutorialMstRecord] = None
class MstApiGetStoryEventScenarioMstListResponse(ResponseBase):
    mstList: List[StoryEventStoryEventScenarioMstRecord] = None
class MstApiGetStoryEventScenarioRewardMstListResponse(ResponseBase):
    mstList: List[StoryEventStoryEventScenarioRewardMstRecord] = None
class MstApiGetStoryEventBonusRateMstListResponse(ResponseBase):
    mstList: List[StoryEventStoryEventBonusRateMstRecord] = None
class MstApiGetDungeonMstListResponse(ResponseBase):
    mstList: List[DungeonDungeonMstRecord] = None
class MstApiGetDungeonTypeMstListResponse(ResponseBase):
    mstList: List[DungeonDungeonTypeMstRecord] = None
class MstApiGetDungeonRoomMstListResponse(ResponseBase):
    mstList: List[DungeonDungeonRoomMstRecord] = None
class MstApiGetDungeonEventMstListResponse(ResponseBase):
    mstList: List[DungeonDungeonEventMstRecord] = None
class MstApiGetFieldStratumMstListResponse(ResponseBase):
    mstList: List[ExplorationFieldStratumMstRecord] = None
class MstApiGetFieldPointMstListResponse(ResponseBase):
    mstList: List[ExplorationFieldPointMstRecord] = None
class MstApiGetBossDirectionMstListResponse(ResponseBase):
    mstList: List[ExplorationBossDirectionMstRecord] = None
class MstApiGetGatheringLevelMstListResponse(ResponseBase):
    mstList: List[GatheringGatheringLevelMstRecord] = None
class MstApiGetGatheringRewardMstListResponse(ResponseBase):
    mstList: List[GatheringGatheringRewardMstRecord] = None
class MstApiGetScoreAttackMstListResponse(ResponseBase):
    mstList: List[ScoreAttackScoreAttackMstRecord] = None
class MstApiGetScoreAttackStageMstListResponse(ResponseBase):
    mstList: List[ScoreAttackScoreAttackStageMstRecord] = None
class MstApiGetScoreAttackHighScoreRewardMstListResponse(ResponseBase):
    mstList: List[ScoreAttackScoreAttackHighScoreRewardMstRecord] = None
class MstApiGetScoreAttackTotalScoreRewardMstListResponse(ResponseBase):
    mstList: List[ScoreAttackScoreAttackTotalScoreRewardMstRecord] = None
class MstApiGetCalculationPointPolicyMstListResponse(ResponseBase):
    mstList: List[CalcPointCalculationPointPolicyMstRecord] = None
class MstApiGetGuildMissionMstListResponse(ResponseBase):
    mstList: List[GuildMissionGuildMissionMstRecord] = None
class MstApiGetGuildMissionTransitionMstListResponse(ResponseBase):
    mstList: List[GuildMissionGuildMissionTransitionMstRecord] = None
